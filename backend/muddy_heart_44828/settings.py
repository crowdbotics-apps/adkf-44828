"""
Django settings for muddy_heart_44828 project.
...
ROOT_URLCONF = 'muddy_heart_44828.urls'
...
WSGI_APPLICATION = 'muddy_heart_44828.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_heart_44828 API",
    "DESCRIPTION": "API documentation for muddy_heart_44828 App",
    "VERSION": "v1",
}
